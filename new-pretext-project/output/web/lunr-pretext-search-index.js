...
},
{
  ...
  "body": " Example multiplication by in base  To follow the previous reasoning and the Lemma, it helps to carefully examine a multiplication base . Consider the multiplication algorithm applied to multiplying by . There is no initial carry so set . First multiplies giving so the unit digit in the product will be and the first carry will be . The next step in the multiplication is times equals plus the carry of making . Then the next digit will be and the next carry will be . The next-to-final step in the multiplication is times equals plus the carry of making . Then the third-from-right digit will be and the final carry will be . is times the phantom fourth digit of equals plus the carry of making . Then the fourth-from-right digit will be and the final carry will be . The multiplication is complete.  "
},
{
